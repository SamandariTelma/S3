...
for (i = 0; (i < resultSize) && (isfound == false); i++) {
    ...
    if (nomActivite.equals('Récupération de Numéro') && nomStatut.equals('En cours')) {
        activite.click()
...
WebUI.callTestCase(findTestCase('04-Activité récupération numéro/00-Called Test Case/Vérification formulaire recuperation numéro'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)
