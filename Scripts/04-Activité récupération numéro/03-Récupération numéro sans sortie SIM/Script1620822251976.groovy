...
WebUI.callTestCase(findTestCase('02-Création activié/07-Création activité récupération numero via un service'), [('numeroResilie') : GlobalVariable.serviceResilie1], FailureHandling.CONTINUE_ON_FAILURE)
