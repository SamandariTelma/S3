...
'Vérifier l\'apparition des éléments suivants dans le formulaire récupération de numéro:\r\n- Titre: Récupération de numéro\r\n- Bouton Action\r\n- Liste déroulante Piece justificative\r\n- Liste déroulante Fiche de récupération\r\n- Liste déroulante Sortie de SIM\r\n- Champ numéro provisoire désactivé\r\n- Champ text commentaire\r\n- Bouton valider et annuler'
WebUI.verifyElementText(findTestObject('Page Activité/Page activité (commun)/Formulaire Récupération de Numéro/Titre Recuperation numero'), 
    'Récupération de Numéro')
