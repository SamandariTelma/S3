...
WebUI.sendKeys(findTestObject('Header/Moteur de recherche'), GlobalVariable.serviceResilie1)
...
for (i = 0; (i < resultSize) && (isfound == false); i++) {
    ...
    if (typeService.equals('Service Mobile / Résilié') && numeroAppel.equals(GlobalVariable.serviceResilie1)) {
        type.click()
...
WebUI.verifyElementText(findTestObject('Page Service/Section Info service/info MSISDN'), GlobalVariable.serviceResilie1)
