...
WebUI.sendKeys(findTestObject('Header/Moteur de recherche'), numeroASwape)
...
for (i = 0; (i < resultSize) && (isfound == false); i++) {
    ...
    if (typeService.equals('Service Mobile / Actif') && numeroAppel.equals(numeroASwape)) {
        type.click()
...
WebUI.verifyElementText(findTestObject('Page Service/Section Info service/info MSISDN'), numeroASwape)
