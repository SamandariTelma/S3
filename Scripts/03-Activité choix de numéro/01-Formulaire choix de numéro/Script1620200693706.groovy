...
for (i = 0; (i < resultSize) && (isfound == false); i++) {
    ...
    if (nomActivite.equals('Choix de Numéro') && nomStatut.equals('En cours')) {
        activite.click()
...
WebUI.callTestCase(findTestCase('03-Activité choix de numéro/00-Called Test Case/Vérification formulaire choix de numéro'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)
