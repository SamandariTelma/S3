...
'Créer un activité choix de numéro'
WebUI.callTestCase(findTestCase('02-Création activié/02-Création activité choix numéro'), [:], FailureHandling.CONTINUE_ON_FAILURE)
