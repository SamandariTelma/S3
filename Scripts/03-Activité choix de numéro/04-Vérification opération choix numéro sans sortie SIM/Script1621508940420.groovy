...
String iccidAncienNumero = "$iccidAncienNumero"
...
WebUI.sendKeys(findTestObject('Header/Moteur de recherche'), nouvelNumero)
...
for (i = 0; (i < resultSize) && (isfound == false); i++) {
    ...
    if (typeService.equals('Service Mobile / Préactivé') && numeroAppel.equals(nouvelNumero)) {
        type.click()
...
WebUI.verifyElementText(findTestObject('Page Service/Section Info service/info MSISDN'), nouvelNumero)

'Vérifier que l\' ICCID du SIM est celui du nouvell ICCID'
WebUI.verifyElementText(findTestObject('Page Service/Section Info service/info SIM'), iccidAncienNumero)
