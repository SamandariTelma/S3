...
WebUI.callTestCase(findTestCase('02-Création activié/06-Création activité choix de numero via un service'), [('numeroPreactif') : GlobalVariable.servicePreactif1], 
